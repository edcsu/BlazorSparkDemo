...
namespace BlazorSparkDemo.Pages.Auth
{
    public class LoginModel : PageModel
    {
        ...
        [BindProperty] public LoginForm loginUser { get; set; }
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            var user = await _usersService.FindUserAsync(loginUser.Email,
                _usersService.GetSha256Hash(loginUser.Password));
